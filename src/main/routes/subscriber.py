...
from src.validators.subscribers_creator_validator import subscribers_creator_valitador
...
from src.controllers.subscribers.subscribers_menager import SubscribersManager
...
def create_new_subs():
    subscribers_creator_valitador(request)
...
def subscribers_by_link(link: str, event_id: str):
    subs_repo = SubscribersRepository()
